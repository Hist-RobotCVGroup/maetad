...
class IterativeReconstruction(nn.Module):
    def __init__(
        self,
        d_model=256,
        window_size=8,
        ...
        self.tda = TemporalDeformableAttention(
            d_model=d_model,
            n_heads=num_heads,
            n_points=num_points
        )

        # GRU for semantic evolution
        ...
        # anomaly score
        self.score_head = nn.Linear(pred_dim, 1)


class MAETAD(nn.Module):
